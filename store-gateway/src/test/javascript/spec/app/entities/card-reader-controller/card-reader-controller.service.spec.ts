...
describe('Service Tests', () => {
    ...
    describe('CardReaderController Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CardReaderControllerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/cashdesk/api/card-reader-controllers';
